...
import { CreateDocumentDto, UpdateDocumentDto } from 'src/lib/types/dto/document.dto';
...
export class DocumentService implements IDocumentService {
    ...
    updateDocumentById(id: string, data: UpdateDocumentDto): Promise<DocumentSchema> {
