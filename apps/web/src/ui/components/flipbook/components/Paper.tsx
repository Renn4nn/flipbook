...
export const Paper = memo(function Paper({
  ...
  const isInteractiveRight = paperNumber === currentState && currentState < maxState
  const isInteractiveLeft = paperNumber === currentState - 1

  const handleClick = isInteractiveRight ? onFlipNext : isInteractiveLeft ? onFlipPrev : undefined
